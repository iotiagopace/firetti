         ...
         <section class="video-area pb-120">
            <div class="container">
               <div class="row">
                  <div class="col-lg-12">
                     <div class="tp-section text-center">
                        <span class="tp-section__sub-title left-line right-line mb-25">Nossa operação</span>
                        <h2 class="tp-section__title mb-60">Do envase ao produto pronto</h2>
                     </div>
                  </div>
               </div>
               <div class="row justify-content-center">
                  <div class="col-lg-10">
                     <div class="firetti-video wow fadeInUp" data-wow-delay=".3s">
                        <video controls preload="none" poster="assets/video/producao-poster.webp">
                           <source src="assets/video/producao.webm" type="video/webm">
                           <source src="assets/video/producao.mp4" type="video/mp4">
                           Seu navegador não reproduz vídeo. <a href="assets/video/producao.mp4">Baixe o vídeo</a>.
                        </video>
                        <p class="firetti-video__legenda">Imagens ilustrativas de envase de cosméticos.</p>
                     </div>
                  </div>
               </div>
            </div>
